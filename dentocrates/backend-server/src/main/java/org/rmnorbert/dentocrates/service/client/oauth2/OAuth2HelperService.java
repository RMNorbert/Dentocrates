package org.rmnorbert.dentocrates.service.client.oauth2;
...
import org.rmnorbert.dentocrates.security.auth.TokenResponse;
...
public class OAuth2HelperService {
    ...
    private final static String NAME_CLAIM = "email";
