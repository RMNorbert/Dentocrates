function Home() {
    const description = "Dentocrates is an innovative online platform designed to revolutionize the way patients find and schedule dental appointments.\n" +
        ...
        "                    At Dentocrates, we understand the challenges patients face in finding suitable dental care. Our platform acts as a centralized appointment system\n" +
        "                    for individual clinics, making it easier than ever to locate available appointments. With Dentocrates, users gain access to a comprehensive network of dental professionals and clinics, ensuring they can find the care they need, even if their preferred dentist is unavailable."
    return (
        <div className='home'>
